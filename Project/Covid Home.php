    ...
    <!--Top menu-->
      ...
      <div class="login">
        <div class="lo">
          ...
          <div>
            <ul class="mid">
            <li><a class="l" href="faq.html" ><img src="faq.png" alt="Faq" style="height:16px ;width:16px;">FAQ</a></li>
            ...
            <li><a class="l"  href="about.html"><img src="admin.png" alt="Admin" style="height:16px ;width:16px;">About Us</a></li>
          </ul>
        </div>
